...
class TestCustomerManagement:
    ...
    def test_add_customers(self, driver: WebDriver) -> None:
        ...
        with allure.step("Submit form and verify confirmation alert"):
            ...
            assert "Customer added successfully" in alert_text, f"Expected success message, got: {alert_text}"
    ...
    def test_delete_customers(self, driver: WebDriver) -> None:
        ...
        with allure.step("Delete customers with average name length and verify deletion"):
